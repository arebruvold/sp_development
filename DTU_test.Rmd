...
```{r}
mathias_torsk_210917 <- sp_wrapper("~/sp-data/17.09.21 Au Ce Ti torsk.b/", acq_time = 120, sample_intake_rate = 0.346, RM_string = "RM", dens_comps = dens_comps, RM_isotope = "Au")
```
